            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="wsus__banner_text_3 wsus__banner_text">
                        <h4>{{ $intro_section->content->home3_title  }}</h4>
                        <h1>{{ $intro_section->content->home3_description  }}</h1>
                ...
                <div class="row">
                    <div class="col-xl-6 col-md-6">
                        <div class="wsus__megapack_card">
                            ...
                            <a class="common_btn" target="_blank" href="{{ $special_offer->home3_item1_link }}">{{__('Buy Goods')}}</a>
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-6">
                        <div class="wsus__megapack_card">
                            ...
                            <a class="common_btn" target="_blank" href="{{ $special_offer->home3_item2_link }}">{{__('Buy Goods')}}</a>
                        </div>
                    </div>
                </div>
            </div>
