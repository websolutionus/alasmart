                                ...
                                <div class="col-12 col-sm-12 col-md-3">
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link active" id="general-setting-tab" data-toggle="tab" href="#generalSettingTab" role="tab" aria-controls="generalSettingTab" aria-selected="true">{{__('General Setting')}}</a>
                                        </li>

                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="logo-tab" data-toggle="tab" href="#logoTab" role="tab" aria-controls="logoTab" aria-selected="true">{{__('Logo and Favicon')}}</a>
                                        </li>
                                        ...
                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="cookie-tab" data-toggle="tab" href="#cookieTab" role="tab" aria-controls="cookieTab" aria-selected="true">{{__('Cookie Consent')}}</a>
                                        </li>

                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="recaptcha-tab" data-toggle="tab" href="#recaptchaTab" role="tab" aria-controls="recaptchaTab" aria-selected="true">{{__('Google Recaptcha')}}</a>
                                        </li>

                                        <li class="nav-item border rounded mb-1 d-none">
                                            <a class="nav-link" id="pusher-tab" data-toggle="tab" href="#pusherTab" role="tab" aria-controls="pusherTab" aria-selected="true">{{__('Pusher Credential')}}</a>
                                        </li>
                                        

                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="tawk-chat-tab" data-toggle="tab" href="#tawkChatTab" role="tab" aria-controls="tawkChatTab" aria-selected="true">{{__('Tawk Chat')}}</a>
                                        </li>

                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="google-analytic-tab" data-toggle="tab" href="#googleAnalyticTab" role="tab" aria-controls="googleAnalyticTab" aria-selected="true">{{__('Google Analytic')}}</a>
                                        </li>

                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="custom-pagination-tab" data-toggle="tab" href="#customPaginationTab" role="tab" aria-controls="customPaginationTab" aria-selected="true">{{__('Custom Pagination')}}</a>
                                        </li>

                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="social-login-tab" data-toggle="tab" href="#socialLoginTab" role="tab" aria-controls="socialLoginTab" aria-selected="true">{{__('Social Login')}}</a>
                                        </li>

                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="facebook-pixel-tab" data-toggle="tab" href="#facebookPixelTab" role="tab" aria-controls="facebookPixelTab" aria-selected="true">{{__('Facebook Pixel')}}</a>
                                        </li>
                                                      ...
                                                      <form action="{{ route('admin.update-general-setting') }}" method="POST" enctype="multipart/form-data">
                                                          ...
                                                          <div class="form-group">
                                                              ...
                                                              <select name="selected_theme" id="" class="form-control">
                                                                  <option {{ $setting->selected_theme == 0 ? 'selected' : '' }} value="0">{{__('All Theme')}}</option>
                                                                  <option {{ $setting->selected_theme == 1 ? 'selected' : '' }} value="1">{{__('Theme One')}}</option>
                                                                  <option {{ $setting->selected_theme == 2 ? 'selected' : '' }} value="2">{{__('Theme Two')}}</option>
                                                                  <option {{ $setting->selected_theme == 3 ? 'selected' : '' }} value="3">{{__('Theme Three')}}</option>
                                                              </select>
                                                          </div>
                                                          ...
                                                          <div class="form-group">
                                                                ...
                                                                <select name="blog_left_right" id="" class="form-control">
                                                                    ...
                                                                    <option {{ $setting->blog_left_right == 1 ? 'selected' : '' }} value="1">{{__('Leftbar')}}</option>
                                                                    <option {{ $setting->blog_left_right == 2 ? 'selected' : '' }} value="2">{{__('Rightbar')}}</option>
                                                                </select>
                                                            </div>
                                                          ...
                                                          <div class="form-group">
                                                              <label for="">{{__('Default Currency Name')}}</label>
                                                              <select name="currency_name" id="" class="form-control select2">
                                                                  <option value="">{{__('Select Default Currency')}}
                                                                </option>
                                                          ...
                                                          <div class="form-group">
                                                              <label for="">{{__('Currency Icon')}}</label>
                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-logo-favicon') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('Home One Existing Logo')}}</label>
                                                                <div>
                                                                    <img src="{{ asset($setting->logo) }}" alt="" width="200px">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">{{__('Home One New Logo')}}</label>
                                                                <input type="file" name="logo" class="form-control-file">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('Home Two Existing Logo')}}</label>
                                                                <div>
                                                                    <img src="{{ asset($setting->logo_two) }}" alt="" width="200px">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">{{__('Home Two New Logo')}}</label>
                                                                <input type="file" name="logo_two" class="form-control-file">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('Home Three Existing Logo')}}</label>
                                                                <div>
                                                                    <img src="{{ asset($setting->logo_three) }}" alt="" width="200px">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">{{__('Home Three New Logo')}}</label>
                                                                <input type="file" name="logo_three" class="form-control-file">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('Home One Footer Logo')}}</label>
                                                                <div>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('Home Tow Footer Logo')}}</label>
                                                                <div>
                                                                    <img src="{{ asset($setting->footer_logo_two) }}" alt="" width="200px">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">{{__('Howe Two New Logo')}}</label>
                                                                <input type="file" name="footer_logo_two" class="form-control-file">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('Home Three Footer Logo')}}</label>
                                                                <div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="allow" id="" class="form-control">
                                                                            <option {{ $cookieConsent->status==1 ? 'selected':'' }} value="1">{{__('Enable')}}</option>
                                                                            <option {{ $cookieConsent->status==0 ? 'selected':'' }} value="0">{{__('Disable')}}</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="border" id="" class="form-control">
                                                                            <option {{ $cookieConsent->border=='none' ? 'selected':'' }} value="none">{{__('None')}}</option>
                                                                            <option {{ $cookieConsent->border=='thin' ? 'selected':'' }} value="thin">{{__('Thin')}}</option>
                                                                            <option {{ $cookieConsent->border=='normal' ? 'selected':'' }} value="normal">{{__('Normal')}}</option>
                                                                            <option {{ $cookieConsent->border=='thick' ? 'selected':'' }} value="thick">{{__('Thick')}}</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="corners" id="" class="form-control">
                                                                            <option {{ $cookieConsent->corners=='none' ? 'selected':'' }} value="none">{{__('none')}}</option>
                                                                            <option {{ $cookieConsent->corners=='small' ? 'selected':'' }} value="small">{{__('Small')}}</option>
                                                                            <option {{ $cookieConsent->corners=='normal' ? 'selected':'' }} value="normal">{{__('Normall')}}</option>
                                                                            <option {{ $cookieConsent->corners=='large' ? 'selected':'' }} value="large">{{__('Large')}}</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <form action="{{ route('admin.update-google-recaptcha') }}" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="allow" id="allow" class="form-control">
                                                                    <option {{ $googleRecaptcha->status == 1 ? 'selected' : '' }} value="1">{{__('Enable')}}</option>
                                                                    <option {{ $googleRecaptcha->status == 0 ? 'selected' : '' }} value="0">{{__('Disable')}}</option>
                                                                </select>
                                                            </div>
                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-pusher') }}" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('App Cluster')}}</label>
                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-tawk-chat') }}" method="POST">
                                                            ...
                                                            @method('PUT')
                                                            <div class="form-group">
                                                                <label for="">{{__('Allow Live Chat')}}</label>
                                                                <select name="allow" id="tawk_allow" class="form-control">
                                                                    <option {{ $tawkChat->status == 1 ? 'selected' : '' }} value="1">{{__('Enable')}}</option>
                                                                    <option {{ $tawkChat->status == 0 ? 'selected' : '' }} value="0">{{__('Disable')}}</option>
                                                                </select>
                                                            </div>
                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-google-analytic') }}" method="POST">
                                                            ...
                                                            @method('PUT')
                                                            <div class="form-group">
                                                                <label for="">{{__('Allow Google Analytic')}}</label>
                                                                <select name="allow" id="tawk_allow" class="form-control">
                                                                    <option {{ $googleAnalytic->status == 1 ? 'selected' : '' }} value="1">{{__('Enable')}}</option>
                                                                    <option {{ $googleAnalytic->status == 0 ? 'selected' : '' }} value="0">{{__('Disable')}}</option>
                                                                </select>
                                                            </div>
                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-social-login') }}" method="POST">
                                                            ...
                                                            @method('PUT')
                                                            <div class="form-group">
                                                                <label for="">{{__('Allow Login with Gmail')}}</label>
                                                                <div>
                                                                    @if ($socialLogin->is_gmail == 1)
                                                                    <input id="status_toggle" type="checkbox" checked data-toggle="toggle" data-on="{{__('Enable')}}" data-off="{{__('Disable')}}" data-onstyle="success" data-offstyle="danger" name="allow_gmail_login">
                                                                    @else
                                                                    <input id="status_toggle" type="checkbox" data-toggle="toggle" data-on="{{__('Enable')}}" data-off="{{__('Disable')}}" data-onstyle="success" data-offstyle="danger" name="allow_gmail_login">
                                                                    @endif
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-facebook-pixel') }}" method="POST">
                                                            ...
                                                            @method('PUT')
                                                            <div class="form-group">
                                                                <label for="">{{__('Allow Facebook Pixel')}}</label>
                                                                <div>
                                                                    @if ($facebookPixel->status == 1)
                                                                    <input id="status_toggle" type="checkbox" checked data-toggle="toggle" data-on="{{__('Enable')}}" data-off="{{__('Disable')}}" data-onstyle="success" data-offstyle="danger" name="allow_facebook_pixel">
                                                                    @else
                                                                    <input id="status_toggle" type="checkbox" data-toggle="toggle" data-on="{{__('Enable')}}" data-off="{{__('Disable')}}" data-onstyle="success" data-offstyle="danger" name="allow_facebook_pixel">
                                                                    @endif
                                                                </div>
                                                            </div>
