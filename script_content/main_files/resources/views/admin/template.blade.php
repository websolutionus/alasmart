      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <a href="{{ route('admin.template.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> {{__('admin.Add New')}}</a>
            <div class="row mt-4">
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                                ...
                                @foreach ($templates as $index => $template)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:;" onclick="changeFeatureStatus({{ $template->id }})">
