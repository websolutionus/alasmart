                                ...
                                @foreach ($currencies as $index => $currency)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($currency->id != 1)
                                                @if ($currency->is_default == 'Yes')
                                                <a href="javascript:;" data-toggle="modal" data-target="#canNotDeleteModal" class="btn btn-danger btn-sm" onclick="deleteData({{ $currency->id }})"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                @else
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                      <div class="modal-body">
                          {{__('admin.You can not delete default currency')}}
                      </div>
