...
@section('frontend-content')
            ...
            <div class="row">
                ...
                <div class="col-xxl-5 col-sm-12 col-lg-5">
                    <div class="wsus__banner_img">
                        ...
                        <p>
                            <span>{{ $intro_section->content->total_product }}{{__('k')}}+</span>
                            {{__('Prodcuts')}}
                        </p>
                    </div>
                </div>
                ...
                <div class="row category_slider">
                    ...
                    <div class="col-xl-3">
                        <div class="wsus__categories_item">
                            ...
                            <h3>{{ $category->name }}</h3>
                            <a class="view_all" href="{{ route('products', ['category' => $category->slug]) }}">{{__('View All')}} <i class="far fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                    @endforeach
                </div>
   ...
   @if ($counter_section->visibitliy)
    ...
    ==============================-->
    <section class="wsus__recent_product pt_115 xs_pt_75">
        <div class="container">
            <div class="row">
                        ...
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                    ...
                                    aria-selected="true"> <i class="far fa-bars"></i> {{__('New
                                    Items')}}</button>
                            </li>
                            <li class="nav-item" role="presentation">
                        ...
                        <div class="wsus__blog_1_text">
                            <ul class="d-flex flex-wrap">
                                <li>
                                    ...
                                    {{__('By')}} {{ $home2_blog_section->blog->admin->name }}
                                </li>
                                <li>
                            ...
                            <a href="{{ route('blog', $home2_blog_section->blog->slug) }}">{{ $home2_blog_section->blog->title }}</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-md-12 col-lg-6">
