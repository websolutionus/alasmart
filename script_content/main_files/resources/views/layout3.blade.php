    ...
    <nav class="navbar navbar-expand-lg main_menu main_menu_3">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home') }}">
                <img src="{{ asset($setting->logo_three) }}" alt="Alasmart" class="img-fluid w-100">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav m-auto">
                    <li class="nav-item">
                        ...
                        <ul class="wsus__droap_menu">
                            ...
                            <li><a class="active" href="{{ route('home',['theme' => 3]) }}">{{__('home three')}}</a></li>
                        </ul>
                        @endif
                    </li>
                    <li class="nav-item">
                ...
                <ul class="right_menu d-flex flex-wrap">
                    ...
                    <li><a class="support_btn" href="{{ route('dashboard') }}">{{__('Dashboard')}}</a></li>
                </ul>
            </div>
        </div>
    </nav>
