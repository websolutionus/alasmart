...
class CurrencyController extends Controller
{
    ...
    {
        $rules = [
            'currency_name'=>'required|unique:multi_currencies,id,'.$id,
            'country_code'=>'required|unique:multi_currencies,id,'.$id,
            'currency_code'=>'required|unique:multi_currencies,id,'.$id,
            'currency_icon'=>'required|unique:multi_currencies,id,'.$id,
            'currency_rate'=>'required|numeric',
        ];
        $customMessages = [
            'currency_name.required' => trans('admin_validation.Currency name is required'),
